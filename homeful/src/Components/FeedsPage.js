...
function FeedsPage(){
  ...
  const [searchInfo, setSearchInfo] = useState('')
    ...
    async function allRooms () {
      let info = await fetch('http://backend-deployment-production.up.railway.app0/rooms/')
        .then(response => {
          if (response.ok){
     ...
     let info = await fetch('http://backend-deployment-production.up.railway.app0/shelters/')
      .then(response => {
        if (response.ok){
          return response.json()
        }
  ...
  async function searchShelterAndRooms (){
    ...
    let shelterInfo = await fetch(`http://backend-deployment-production.up.railway.app0/shelters/search/${searchInfo}`)
    .then(response => {
      if (response.ok){
        return response.json()
      }
    ...
    let roomInfo = await fetch(`http://backend-deployment-production.up.railway.app0/rooms/search/${searchInfo}`)
    .then(response => {
      if (response.ok){
        return response.json()
      }
 ...
 async function getcategory (category){
  ...
  let shelterInfo = await fetch(`http://backend-deployment-production.up.railway.app0/shelters/category/${category}`)
    .then(response => {
      if (response.ok){
        return response.json()
      }
    ...
    let roomInfo = await fetch(`http://backend-deployment-production.up.railway.app0/rooms/category/${category}`)
    .then(response => {
      if (response.ok){
        return response.json()
      }
